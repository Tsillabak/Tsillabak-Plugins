...
class EssenceMinerOverlay extends OverlayPanel
{
	...
	@Inject
	public EssenceMinerOverlay(final Client client, final EssenceMinerPlugin plugin, final EssenceMinerConfiguration config)
	{
		super(plugin);
		setPosition(OverlayPosition.BOTTOM_LEFT);
		this.plugin = plugin;
		this.config = config;
		getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "Essence Miner Overlay"));
	}
