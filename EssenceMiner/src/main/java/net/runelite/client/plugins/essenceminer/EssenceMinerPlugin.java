...
@PluginDescriptor(
	...
	description = "mines essence at varrock east bank.",
	tags = {"Essence, Shit, Miner, Tsillabak"}
)
@Slf4j
public class EssenceMinerPlugin extends Plugin {
	...
	EssenceMinerState getState() {
		...
		if (player.getWorldLocation().equals(new WorldPoint(3253, 3401, 0))&& !inventory.isFull() ) {
			return CLICK_AUBURY;
		}
